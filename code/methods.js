import { RestorationProduct, StoreProduct, VideoHosting } from "./class.js";
...
export function showInputModal(category) {
    ...
    if (category === "Ресторан") {
       ...
       form = `<form data-category="${category}" id="category-form">
        ...
        form = `<form data-category="${category}" id="category-form">
                ${patternCreateInputForModal("Назва фильму", undefined, generatorID(), "movieName")}
                ${patternCreateInputForModal("Рік виходу", "number", generatorID(), "movieReleasedYear")}
                ${patternCreateInputForModal("Афіша", "url", generatorID(), "movieImage")}
                ${patternCreateInputForModal("Посилання", "url", generatorID(), "movilink")}
                ${patternCreateInputForModal("Режисер", undefined, generatorID(), "movieDirector")}
                ${patternCreateInputForModal("Опис фильму", undefined, generatorID(), "movieDescription")}
                ${patternCreateInputForModal("Актори", undefined, generatorID(), "actors")}
        </form>
        ` 
    }
